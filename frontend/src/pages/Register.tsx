...
export default function Register() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await register(username, email, password); // 👈 llamada al backend
        ...
        <div className="min-h-screen flex flex-col lg:flex-row">
            ...
            <div className="flex-1 relative hidden lg:block bg-gradient-to-br from-blue-600 to-blue-800">
                <img 
                    ...
                    onLoad={() => console.log('Imagen cargada correctamente en Register')}
                    onError={(e) => {
                        console.error('Error al cargar la imagen en Register');
